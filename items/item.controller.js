...
class ItemController {
    ...
    async update(req, res) {
        try {
            const { id, name, description, price, oldPrice, image, additionalData } = req.body
            const data = await ItemModule.update(id, name, description, price, oldPrice, image, additionalData)
